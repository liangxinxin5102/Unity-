...
public class Player : MonoBehaviour {
	...
	void Update () {
        ...
        if ( m_rocketRate <= 0 )
        {
            ...
            {
                //Instantiate( m_rocket, m_transform.position, m_transform.rotation );  // 此处代码删除
                DarkTonic.CoreGameKit.PoolBoss.Spawn("Rocket", m_transform.position, m_transform.rotation, null);
